"""
Repeat_and_statistics_LTV_CM.py
...
# ═══════════════════════════════════════════════════════════════════════════════
print("=" * 65)
print("  DataFusion 10-Repeat Statistics Benchmark  [LTV / CM]")
print("=" * 65)
...
# 5. 保存结果到 Excel
# ═══════════════════════════════════════════════════════════════════════════════
out_xlsx = os.path.join(SCRIPT_DIR, 'Repeat_statistics_LTV_CM_results.xlsx')
...
fig.suptitle('DataFusion Algorithm 10-Repeat Benchmark (LTV / CM)\n'
...
plt.tight_layout()
out_fig = os.path.join(SCRIPT_DIR, 'Repeat_statistics_LTV_CM.png')
